/*
  # Fix Question Duplicate Detection

  1. Changes
    - Update normalization function to be more lenient
    - Add similarity threshold for duplicate detection
    - Improve error messages with suggestions
    - Add function to find similar questions
