...
const TopicsModal = ({ isOpen, onClose }: Props) => {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            <p className="text-gray-600 dark:text-gray-300">
              The NCLEX test plan is organized by topics and subtopics. These categories reflect the core areas of nursing practice and form the framework for nursing education and examination. Understanding these categories is crucial for effective test preparation.
            </p>
            
            <div className="mt-4 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
              <h4 className="font-medium text-blue-800 dark:text-blue-200 mb-2">About Topic Percentages</h4>
              <p className="text-blue-700 dark:text-blue-300">
                The percentage ranges shown for each topic (e.g., "17-23%") indicate the proportion of questions from that category that will appear on your NCLEX exam. These ranges are set by the National Council of State Boards of Nursing (NCSBN) and represent the distribution of content on the actual NCLEX examination.
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Key Subtopics:</h4>
                        <ul className="space-y-1">
                          {topic.keySubtopics.map((subtopic, tIndex) => (
          ...
          <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            ...
            <ul className="space-y-2 text-blue-700 dark:text-blue-300">
              <li>• Focus on topics with higher percentage ranges first</li>
              <li>• Practice questions from all topics to ensure comprehensive preparation</li>
              <li>• Pay special attention to Management of Care and Pharmacological Therapies</li>
              <li>• Review both normal and abnormal findings for each topic</li>
            </ul>
          </div>
        </div>
      </div>
